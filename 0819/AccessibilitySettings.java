...
public class AccessibilitySettings extends SettingsPreferenceFragment implements
    ...
    //add liujingyi
    private static final String SCREEN_ZOOM_PREFERENCE_SCREEN =
            "accessibility_settings_screen_zoom";
    ...
    //add liujingyi
    private Preference mScreenZoomPreferenceScreen;
    ...
    private void initializeAllPreferences() {
        ...
        // Font size.
        mScreenZoomPreferenceScreen = findPreference(SCREEN_ZOOM_PREFERENCE_SCREEN);
    ...
    protected void updateSystemPreferences() {
        ...
        if (isColorTransformAccelerated(getContext())) {
            ...
            //add jingyi
            displayCategory.removePreference(mFontSizePreferenceScreen);
            displayCategory.removePreference(mScreenZoomPreferenceScreen);
        }
